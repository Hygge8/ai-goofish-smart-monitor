const zhCNExtra = {
  ...
  notifyPanel: {
    ...
    secretConfigured: '已配置敏感值，当前页面不回显。',
    notConfigured: '尚未配置。',
    ntfy: {
    ...
    webhook: {
      title: '自定义 Webhook',
      description: '适合接入自建服务，可选择 GET/POST、Header、Query 和 Body 模板。',
      urlLabel: 'Webhook URL',
      methodLabel: '请求方法',
      contentTypeLabel: '内容类型',
      headersLabel: '请求头 JSON',
      queryLabel: 'Query 参数 JSON',
      bodyLabel: '请求体 JSON / 模板',
      headersPlaceholder: '示例：',
      queryPlaceholder: '示例：',
      bodyPlaceholder: '示例：',
      variablesHelp: 'Body / Query 可引用以下变量。',
    },
  },
}
