...
app = FastAPI(title="闲鱼 AI 智能监控助手")
...
def index():
    ...
    <body>
      <div class="card">
        <h1>闲鱼 AI 智能监控助手</h1>
        <p>项目名：ai-goofish-smart-monitor</p>
        <p class="error">{error}</p>
        <table>
          <thead><tr><th>图片</th><th>标题</th><th>价格</th><th>地区</th><th>关键词</th><th>链接</th></tr></thead>
          <tbody>{rows}</tbody>
        </table>
      </div>
    </body>
